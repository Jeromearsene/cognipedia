...
```json
{
  ...
  "choices": [
    { "label": "320 000EUR, c'est une bonne affaire !", "bias": true },
    { "label": "Je dois verifier les prix du marche avant de juger", "bias": false }
  ],
  ...
  "questions": [
    {
      ...
      "choices": ["On manque d'information sur le sujet", "On est expert du domaine", "On prend son temps pour decider"],
      "correct": 0,
    ...
    },
    {
      ...
      "choices": ["Afficher un prix barre avant le prix reel", "Proposer la livraison gratuite", "Offrir un echantillon gratuit"],
      "correct": 0,
